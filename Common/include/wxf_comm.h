...
typedef void *									wxf_handle;
typedef unsigned long							wxf_bool;							
#ifdef _WIN32
...
#define wxf_print(...)							(wxf_printf(WXF_PROMPT),\
												 wxf_printf(__VA_ARGS__))
#ifndef _DEBUG_LEVEL
...
#ifndef WXF_LIB
#pragma comment(lib,"wxf_comm.lib")
#endif //_DEBUG
